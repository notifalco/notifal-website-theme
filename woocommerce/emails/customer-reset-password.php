...
<p><?php printf( esc_html__( 'Hi %s,', 'woocommerce' ), $user_name ?? $user_login ); ?></p>
<?php /* translators: %s: Store name */ ?>
<p>We received a request to reset your password. If this was you, no worries, you can reset your password by clicking the button below:</p>
<p>
