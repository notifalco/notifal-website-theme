								...
								<td align="center" valign="top">
									...
									if ( $email_improvements_enabled ) :
										...
										<table border="0" cellpadding="0" cellspacing="0" width="100%">
											<tr>
												<td id="template_header_image" style="text-align: center;">
													<?php
													if ( $img ) {
														echo '<p style="margin-top:0; text-align: center;"><img src="' . esc_url( $img ) . '" alt="' . esc_attr( get_bloginfo( 'name', 'display' ) ) . '" style="display: block; margin: 0 auto;" /></p>';
													} else {
														echo '<p class="email-logo-text" style="text-align: center;">' . esc_html( get_bloginfo( 'name', 'display' ) ) . '</p>';
													}
													?>
												</td>
											</tr>
